...
preparation_types = rbind(
  # Raw
  data.frame(name = c("raw","Raw","r","wet","crudo",
                      "cruda","cru","Fresh","flesh","flesh","sa",
                      "raw \\(Alaska Native\\)","Raw","crudo","fridge","minced"),
             type = "raw"),
  # freezedried
  data.frame(name = c("freeze-dried", "freeze dried","Freeze dried ",
                      "freezedried","Freeze-dried","freeze-dried, dried",
                      "freeze fried", #clearly spelling error!
                      "Freezedried"),
             type = "freezedried"),
  # rehydrated
  data.frame(name = c("rehydrated"),
             type = "rehydrated"),
  # unknown_preparation
  data.frame(name = c("unknown","NA","b","sl","not specified",
                      "conserva","0","Control","wet","fz","fe","e","Experiment"),
             type = "unknown_preparation"),
  # dried
  data.frame(name = c("dried","dry","d","Dry","dried and homogenized",
                      "air-dried","Dried","seco"),
             type = "dried"),
  # baked
  data.frame(name = c("baked","baked","baked / broiled","al horno","broiled","bake","broiled/baked"),
             type = "baked"),
  # boiled_steamed
  data.frame(name = c("boil","boiled","boiled ","boiled/steamed","steamed","st",
                      "hervido","poached","precocido","cozido"),
             type = "boiled_steamed"),
  #fried
  data.frame(name = c("fried","f","frito","frita"),
             type = "fried"),
  #canned <- 
  data.frame(name = c("canned","c","enlatado","canned, drained","enlatada"),
             type = "fried"),
  data.frame(name = c("fried","f","frito","frita"),
             type = "fried"),
  data.frame(name = c("fried","f","frito","frita"),
